...
final class ZTTipViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        amountTextField.font = UIFont(name: "Wawati SC", size: 32)
        amountTextField.textColor = UIColor.whiteColor()
        amountTextField.attributedPlaceholder = NSAttributedString(string:"Enter an amount..", attributes: [NSForegroundColorAttributeName: UIColor.whiteColor(), NSFontAttributeName :UIFont(name: "Wawati SC", size: 32)!])
    ...
    func resetView() {
        ...
        //fix tableview
        descriptionTableView.setContentOffset(CGPointZero, animated: true)
    ...
    func setConstraints() {
        ...
        descriptionTableView.centerXAnchor.constraintEqualToAnchor(view.centerXAnchor, constant: 80).active = true
        descriptionTableView.widthAnchor.constraintEqualToAnchor(nil, constant: 150).active = true
        descriptionTableView.heightAnchor.constraintEqualToAnchor(nil, constant: 200).active = true
        ...
        backButton.leadingAnchor.constraintEqualToAnchor(margins.leadingAnchor, constant: 0).active = true
//        backButton.topAnchor.constraintEqualToAnchor(margins.topAnchor, constant: 12).active = true
        backButton.centerYAnchor.constraintEqualToAnchor(amountTextField.centerYAnchor).active = true
